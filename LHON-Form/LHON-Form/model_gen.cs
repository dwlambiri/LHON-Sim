...
namespace LHON_Form
{
    public partial class Main_Form : Form
    {
        ...
        private const float mdl_real_nerve_r = 750; // um
        private const int mdl_real_num_axons = 1200000;
        private float mdl_clearance = 0.2F; // um
        private const float mdl_vessel_ratio = 0.1F; // 0 - 1

        //private const float axon_min_r = 0.19F / 2;
        ...
        private string axon_radius_cdf_file = @"../../../../Matlab\pdf_from_graph\axon_radius_cdf.tbl";
        private string axon_mean_radius_file = @"../../../../Matlab\pdf_from_graph\axon_mean_radius.tbl";
