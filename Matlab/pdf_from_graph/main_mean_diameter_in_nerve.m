...
mean_diameter = flipud(mean_diameter);
...
% figure, plot(sf,[x(:) y(:)], mean_diameter(:)); xlabel('X');ylabel('Y');zlabel('Z');
...
fclose(fid);
% x and y matches Pan paper

xlswrite('axon_mean_raduis.xlsx',mean_mesh_radius);
