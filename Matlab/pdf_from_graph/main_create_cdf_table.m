...
cdf_tbl(:,1) = variation.diameter_mean/2; % First column: average diameter
...
if ~study_three_means_only
    ...
    fclose(fid);
    xlswrite('axon_radius_cdf.xlsx',cdf_tbl);
    fprintf('Table successfully generated.\n')
end

%%

surf(cdf_tbl(2:20:end,2:20:end), 'linestyle', 'none')
